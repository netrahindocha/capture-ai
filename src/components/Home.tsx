...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section
        id="hero"
        className="bg-neutral-900 min-h-screen pt-16 relative overflow-hidden"
      >
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 animate__animated animate__fadeIn"></div>
          <div className="absolute h-56 w-56 top-20 left-20 rounded-full bg-indigo-600/20 blur-3xl"></div>
          <div className="absolute h-64 w-64 bottom-20 right-20 rounded-full bg-purple-600/20 blur-3xl"></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col items-center justify-center pt-20 pb-16 text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 animate__animated animate__fadeInDown">
              Transform Speech to{" "}
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl animate__animated animate__fadeInUp">
              Get instant transcripts and intelligent summaries from your
              recordings with our AI-powered space-age technology
            </p>

            <div className="flex flex-col sm:flex-row gap-6 mb-16 animate__animated animate__fadeInUp">
              <button
                onClick={navigateToRecording}
                className="px-8 py-4 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold text-lg hover:opacity-90 transform hover:scale-105 transition-all"
              >
                Start Recording
              </button>
              <button
                onClick={navigateToRecording}
                className="px-8 py-4 rounded-full border-2 border-indigo-400 text-white font-semibold text-lg hover:bg-indigo-600/20 transform hover:scale-105 transition-all"
              >
                Upload Audio
              </button>
            </div>

            <div className="w-full max-w-4xl p-8 bg-neutral-800/50 backdrop-blur-xl rounded-2xl border border-neutral-700 animate__animated animate__fadeInUp">
              <div className="flex flex-col sm:flex-row items-center gap-6 justify-between">
                ...
                <div className="flex gap-4">
                  <select className="bg-neutral-700 text-white px-4 py-2 rounded-lg border-r-8 border-transparent">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-neutral-700/50 backdrop-blur-xl rounded-2xl p-8 border border-neutral-600 transform hover:scale-105 transition-all animate__animated animate__fadeInLeft">
              ...
              <button
                onClick={navigateToRecording}
                className="w-full py-3 px-6 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition-all"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="bg-gradient-to-b from-neutral-700/50 to-neutral-800/50 backdrop-blur-xl rounded-2xl p-8 border border-indigo-500 transform hover:scale-105 transition-all animate__animated animate__fadeInUp relative">
              ...
              <button
                onClick={navigateToRecording}
                className="w-full py-3 px-6 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:opacity-90 transition-all"
              >
                Get Started
              </button>
            </div>
